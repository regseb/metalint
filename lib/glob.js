 ...
 * @param {string}   root     L'adresse du répertoire où se trouve le dossier
 *                            <code>.metalint/</code>.
 * @returns {string[]} La liste des fichiers respectant un des patrons.
 */
 ...
 */
export const test = function (file, patterns, root, directory) {
 ...
 * @returns {string[]} La liste des fichiers respectant un des patrons.
 */
export const walk = function (bases, patterns, root) {
